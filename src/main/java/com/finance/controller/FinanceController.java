...
public class FinanceController {
	...
	public FinanceController(FinanceService financeService, InstituteService instituteService, InstituteRepository iRepository,
			InstituteFinanceRepository iFinanceRepository) {
	...
	public ResponseEntity getAllInstituteFinance(Map<String, Integer> bankFinanceMap, Map<String, String> bankNameMap) {
		try {
			return new ResponseEntity<>(financeService.listingFinanceStatus(bankFinanceMap, bankNameMap), httpHeaders, HttpStatus.OK);
		} catch (Exception e) {
